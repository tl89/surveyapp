...
return document.getElementById(_49f);
...
this.open=function(_4a0,_4a1){
if(self.WebSocket||self.MozWebSocket){
if(!this.wsConnection){
var _4a2=this;
if("MozWebSocket" in window){
this.wsConnection=new MozWebSocket(_4a0,"json");
}else{
this.wsConnection=new WebSocket(_4a0);
}
this.wsConnection.connectionOptions=_4a1;
this.onWelcome=_4a1.OnWelcome;
this.wsConnection.onopen=function(_4a3){
if(_4a1.OnWelcome){
_4a1.OnWelcome(_4a2);
}
};
this.wsConnection.onmessage=function(_4a4){
var _4a5=_4a2.streamToToken(_4a4.data);
if(_4a5.code&&_4a1.onError&&(_4a5.code==cf_ws.APP_ERROR_CODE||_4a5.code==cf_ws.CHANNEL_ERROR_CODE)){
_4a1.onError(_4a5,_4a2);
}else{
if(_4a1.OnMessage){
if(_4a5.data){
if(cf_ws.validRE.test(_4a5.data)){
_4a5.data=_4a2.streamToToken(_4a5.data);
}
}
_4a1.OnMessage(_4a5,_4a2);
}
}
};
this.wsConnection.onclose=function(_4a6){
...
},this.sendStream=function(_4a8){
if(this.wsConnection&&this.wsConnection.readyState==cf_ws.OPEN){
this.wsConnection.send(_4a8);
}else{
throw new Error("Connection not established.");
}
},this.isConnected=function(){
return (this.wsConnection!=null&&this.wsConnection.readyState==cf_ws.OPEN);
},this.forceClose=function(_4a9){
},this.close=function(_4aa){
if(this.wsConnection){
...
},this.checkCallbacks=function(_4ab){
var _4ac="utid"+_4ab.utid;
},this.createDefaultResult=function(){
return {code:0,msg:"Ok",localeKey:"jws.jsc.res.Ok",args:null,tid:jws.CUR_TOKEN_ID};
},this.tokenToStream=function(_4ad){
return ColdFusion.JSON.encode(_4ad);
...
},this.processResponsePacket=function(_4af){
var _4b0=ColdFusion.JSON.decode(_4af.data);
if(_4b0.type){
if(_4b0.type=="welcome"&&_4b0.usid){
this.fSessionId=_4b0.usid;
this.fClientId=_4b0.sourceId;
if(this.fOnWelcome){
this.fOnWelcome(_4b0);
}
}else{
if(_4b0.type=="goodBye"){
if(this.fOnGoodBye){
this.fOnGoodBye(_4b0);
}
...
if(_4b0.type=="response"){
this.checkCallbacks(_4b0);
}else{
...
},this.sendToken=function(_4b1){
if(this.isConnected()){
var _4b2=ColdFusion.JSON.encode(_4b1);
this.wsConnection.send(_4b2);
}else{
throw new Error("Connection not established.");
}
},this.startKeepAlive=function(_4b3){
...
_53d.error("Flash Player >= 10.0.0 is required.");
return;
}
if(location.protocol=="file:"){
_53d.error("WARNING: web-socket-js doesn't work in file:///... URL "+"unless you set Flash Security Settings properly. "+"Open the page via Web server i.e. http://...");
}
window.WebSocket=function(url,_53f,_540,_541,_542){
var self=this;
...
WebSocket.__flash.create(self.__id,url,_53f,_540||null,_541||0,_542||null,_cf_flash_policy_port||1243);
});
},0);
};
...
var _545=WebSocket.__flash.send(this.__id,encodeURIComponent(data));
if(_545<0){
return true;
}else{
this.bufferedAmount+=_545;
return false;
}
};
...
WebSocket.prototype.addEventListener=function(type,_547,_548){
if(!(type in this.__events)){
this.__events[type]=[];
}
this.__events[type].push(_547);
};
WebSocket.prototype.removeEventListener=function(type,_54a,_54b){
if(!(type in this.__events)){
return;
}
var _54c=this.__events[type];
for(var i=_54c.length-1;i>=0;--i){
if(_54c[i]===_54a){
_54c.splice(i,1);
break;
}
...
WebSocket.prototype.dispatchEvent=function(_54e){
var _54f=this.__events[_54e.type]||[];
for(var i=0;i<_54f.length;++i){
_54f[i](_54e);
}
var _551=this["on"+_54e.type];
if(_551){
_551.apply(this,[_54e]);
}
};
WebSocket.prototype.__handleEvent=function(_552){
if("readyState" in _552){
this.readyState=_552.readyState;
}
if("protocol" in _552){
this.protocol=_552.protocol;
}
var _553;
if(_552.type=="open"||_552.type=="error"){
_553=this.__createSimpleEvent(_552.type);
}else{
if(_552.type=="close"){
_553=this.__createSimpleEvent("close");
_553.wasClean=_552.wasClean?true:false;
_553.code=_552.code;
_553.reason=_552.reason;
}else{
if(_552.type=="message"){
var data=decodeURIComponent(_552.message);
_553=this.__createMessageEvent("message",data);
}else{
throw "unknown event type: "+_552.type;
}
}
}
this.dispatchEvent(_553);
};
WebSocket.prototype.__createSimpleEvent=function(type){
if(document.createEvent&&window.Event){
var _556=document.createEvent("Event");
_556.initEvent(type,false,false);
return _556;
}else{
...
var _559=document.createEvent("MessageEvent");
_559.initMessageEvent("message",false,false,data,null,null,window,null);
return _559;
}else{
...
_53d.error("[WebSocket] set WEB_SOCKET_SWF_LOCATION to location of WebSocketMain.swf");
return;
}
...
var _55b=RegExp.$1;
if(location.host!=_55b){
_53d.error("[WebSocket] You must host HTML and WebSocketMain.swf in the same host "+"('"+location.host+"' != '"+_55b+"'). "+"See also 'How to host HTML file and SWF file in different domains' section "+"in README.md. If you use WebSocketMainInsecure.swf, you can suppress this message "+"by WEB_SOCKET_SUPPRESS_CROSS_DOMAIN_SWF_ERROR = true;");
}
}
var _55c=document.createElement("div");
_55c.id="webSocketContainer";
_55c.style.position="absolute";
if(WebSocket.__isFlashLite()){
_55c.style.left="0px";
_55c.style.top="0px";
}else{
_55c.style.left="-100px";
_55c.style.top="-100px";
}
var _55d=document.createElement("div");
_55d.id="webSocketFlash";
_55c.appendChild(_55d);
document.body.appendChild(_55c);
...
if(!e.success){
_53d.error("[WebSocket] swfobject.embedSWF failed");
}
});
};
...
setTimeout(function(){
try{
var _560=WebSocket.__flash.receiveEvents();
for(var i=0;i<_560.length;++i){
WebSocket.__instances[_560[i].webSocketId].__handleEvent(_560[i]);
}
}
catch(e){
_53d.error(e);
...
WebSocket.__log=function(_562){
_53d.log(decodeURIComponent(_562));
};
WebSocket.__error=function(_563){
_53d.error(decodeURIComponent(_563));
};
...
var _565=window.navigator.mimeTypes["application/x-shockwave-flash"];
if(!_565||!_565.enabledPlugin||!_565.enabledPlugin.filename){
return false;
}
return _565.enabledPlugin.filename.match(/flashlite/i)?true:false;
};
...
return escapable.test(_56a)?"\""+_56a.replace(escapable,function(a){
var c=meta[a];
return typeof c==="string"?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4);
})+"\"":"\""+_56a+"\"";
}
function str(key,_56e){
var i,k,v,length,mind=gap,partial,value=_56e[key];
if(value&&typeof value==="object"&&typeof value.toJSON==="function"){
value=value.toJSON(key);
}
if(typeof rep==="function"){
value=rep.call(_56e,key,value);
}
switch(typeof value){
case "string":
return quote(value);
...
JSON.stringify=function(_570,_571,_572){
var i;
gap="";
indent="";
if(typeof _572==="number"){
for(i=0;i<_572;i+=1){
indent+=" ";
}
}else{
...
rep=_571;
if(_571&&typeof _571!=="function"&&(typeof _571!=="object"||typeof _571.length!=="number")){
...
JSON.parse=function(text,_575){
var j;
function walk(_577,key){
var k,v,value=_577[key];
...
return _575.call(_577,key,value);
}
text=String(text);
cx.lastIndex=0;
if(cx.test(text)){
...
j=eval("("+text+")");
return typeof _575==="function"?walk({"":j},""):j;
}
throw new SyntaxError("JSON.parse");
};
}
}());
var Base64={_keyStr:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",encode:function(_57b){
var _57c="";
var chr1,chr2,chr3,enc1,enc2,enc3,enc4;
var i=0;
_57b=Base64._utf8_encode(_57b);
while(i<_57b.length){
chr1=_57b.charCodeAt(i++);
chr2=_57b.charCodeAt(i++);
chr3=_57b.charCodeAt(i++);
enc1=chr1>>2;
...
_57c=_57c+this._keyStr.charAt(enc1)+this._keyStr.charAt(enc2)+this._keyStr.charAt(enc3)+this._keyStr.charAt(enc4);
}
return _57c;
},decode:function(_57f){
var _580="";
var chr1,chr2,chr3;
var enc1,enc2,enc3,enc4;
var i=0;
_57f=_57f.replace(/[^A-Za-z0-9\+\/\=]/g,"");
while(i<_57f.length){
enc1=this._keyStr.indexOf(_57f.charAt(i++));
enc2=this._keyStr.indexOf(_57f.charAt(i++));
enc3=this._keyStr.indexOf(_57f.charAt(i++));
enc4=this._keyStr.indexOf(_57f.charAt(i++));
chr1=(enc1<<2)|(enc2>>4);
chr2=((enc2&15)<<4)|(enc3>>2);
chr3=((enc3&3)<<6)|enc4;
_580=_580+String.fromCharCode(chr1);
if(enc3!=64){
_580=_580+String.fromCharCode(chr2);
}
if(enc4!=64){
_580=_580+String.fromCharCode(chr3);
}
}
_580=Base64._utf8_decode(_580);
return _580;
},_utf8_encode:function(_584){
_584=_584.replace(/\r\n/g,"\n");
var _585="";
for(var n=0;n<_584.length;n++){
var c=_584.charCodeAt(n);
if(c<128){
_585+=String.fromCharCode(c);
}else{
if((c>127)&&(c<2048)){
_585+=String.fromCharCode((c>>6)|192);
_585+=String.fromCharCode((c&63)|128);
}else{
_585+=String.fromCharCode((c>>12)|224);
_585+=String.fromCharCode(((c>>6)&63)|128);
_585+=String.fromCharCode((c&63)|128);
}
}
}
return _585;
},_utf8_decode:function(_588){
var _589="";
var i=0;
var c=c1=c2=0;
while(i<_588.length){
c=_588.charCodeAt(i);
if(c<128){
_589+=String.fromCharCode(c);
i++;
}else{
if((c>191)&&(c<224)){
c2=_588.charCodeAt(i+1);
_589+=String.fromCharCode(((c&31)<<6)|(c2&63));
i+=2;
}else{
c2=_588.charCodeAt(i+1);
c3=_588.charCodeAt(i+2);
_589+=String.fromCharCode(((c&15)<<12)|((c2&63)<<6)|(c3&63));
i+=3;
}
}
}
